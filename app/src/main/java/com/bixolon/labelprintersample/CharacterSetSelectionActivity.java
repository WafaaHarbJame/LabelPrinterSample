...
public class CharacterSetSelectionActivity extends Activity implements OnClickListener {
	...
	String mInternationalCharactershared;
	String mCodePageshared;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(sharedPManger.getDataString("mInternationalCharacterSetTextView")!=null&
				sharedPManger.getDataString("mCodePageTextView")!=null){
			 mInternationalCharactershared=sharedPManger.getDataString("mInternationalCharacterSetTextView");
			 mCodePageshared=sharedPManger.getDataString("mCodePageTextView");
			 mInternationalCharacterSetTextView.setText(mInternationalCharactershared);
			 mCodePageTextView.setText(mCodePageshared);
	...
	public void onClick(View v) {
		...
		case R.id.button3:
			...
			Toast.makeText(this, ""+mCodePage, Toast.LENGTH_SHORT).show();
			Toast.makeText(this, ""+mInternationalCharacterSet, Toast.LENGTH_SHORT).show();
	...
	private void showInternationalCharacterSetDialog() {
		if (mInternationalCharacterSetDialog == null) {
			mInternationalCharacterSetDialog = new AlertDialog.Builder(CharacterSetSelectionActivity.this)
					.setTitle(R.string.international_chracter_set)
				.setItems(INTERNATIONAL_CHARACTER_SET_ITEMS, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						sharedPManger.SetData("mInternationalCharacterSet",mInternationalCharacterSet);
						sharedPManger.SetData("mInternationalCharacterSetTextView",INTERNATIONAL_CHARACTER_SET_ITEMS[which]);
					}
				}).create();
		}
	...
	private void showCodePageDialog() {
		if (mCodePageDialog == null) {
			mCodePageDialog = new AlertDialog.Builder
					(CharacterSetSelectionActivity.this).setTitle(R.string.code_pages)
		...
		sharedPManger.SetData("mCodePageTextView",CODE_PAGE_ITEMS[which]);
						sharedPManger.SetData("mCodePage",mCodePage);
