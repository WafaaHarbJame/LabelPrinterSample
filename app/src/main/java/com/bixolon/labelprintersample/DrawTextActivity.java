...
public class DrawTextActivity extends Activity implements View.OnClickListener, OnSeekBarChangeListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*if (!(sharedPManger.getDataInt("mInternationalCharacterSet") & sharedPManger.getDataInt("mCodePage"))) {
			return;
		}*/

		mInternationalCharacterSet=sharedPManger.getDataInt("mInternationalCharacterSet");
		mCodePage=sharedPManger.getDataInt("mCodePage");
