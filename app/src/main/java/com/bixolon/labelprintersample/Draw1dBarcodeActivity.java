	...
	public void onClick(DialogInterface dialog, int which) {
		if (dialog == mBarcodeSelectionDialog) {
			...
			case 9:
				...
				break;
			case 10:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_CODE11;
				break;
			case 11:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_PLANET;
				break;
			case 12:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_INDUSTRIAL_2OF5;
				break;
			case 13:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_STANDARD_2OF5;
				break;
			case 14:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_LOGMARS;
				break;
			case 15:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_UPC_EAN_EXTENSIONS;
				break;
			case 16:
				mBarcodeSelection = BixolonLabelPrinter.BARCODE_POSTNET;
				break;
			}
